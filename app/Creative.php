...
class   Creative extends ModelSetup implements Uuidable
{
	...
	public static function generateAdm($campaignId, $creativeId, $type = '')
	{
		...
		switch ($type) {
			case 'iframe':
				return "<iframe src='" . env('AD_SERVER_URL') . "/paint/{$creativeId}?type=html5&{{ADM_URL}}' marginwidth='0' marginheight='0' align='top' scrolling='no' frameborder='0' hspace='0' vspace='0'  height='{$creative->h}' width='{$creative->w}'></iframe>";
				break;
